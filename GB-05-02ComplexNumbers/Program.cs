...
namespace GB_05_02ComplexNumbers
{
    class ComplexNumbers      //  комплексные числа     z=a+bi
    {
        ...
        {
            ComplexNumbers cn3 = new(cn1._realPart + cn2._realPart, cn1._imaginaryPart + cn2._imaginaryPart);
    ...
    class Program
    {
        ...
        {
            ComplexNumbers complex1 = new(2, 5);
            ComplexNumbers complex2 = new(6, 3);
            ComplexNumbers complex3 = new(8, 4);
            ComplexNumbers complex4 = new(8, 0);
            ComplexNumbers complex5 = new(0, 5);
