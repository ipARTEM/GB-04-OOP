...
namespace GB_05_01
{
    public class RationalNumbers
    {
        ...
        public static RationalNumbers operator +(RationalNumbers r1, RationalNumbers r2)
        {
            ...
            RationalNumbers r3 = new(newNumerator, newDenominator);
            r3 = r3.Reduction();
            return r3;
        }
        ...
        public static RationalNumbers operator ++(RationalNumbers r1)
        {
            ...
            RationalNumbers r3 = new(newNumerator, r1._denominator);
            r3 = r3.Reduction();
            return r3;
        }
    ...
    class Program
    {
        ...
        {
            RationalNumbers rational1 = new(15,7);
            RationalNumbers rational2 = new(7,8);
            RationalNumbers rational3 = new(17,8);

            RationalNumbers rational4 = new(10, 18);
            RationalNumbers rational5 = new(15, 21);
            RationalNumbers rational6 = new(36, 18);

            RationalNumbers rational7 = new(6, 3);
            RationalNumbers rational8 = new(8, 3);

            RationalNumbers rational9 = new(10, 3);
            RationalNumbers rational10 = new(3, 3);

            RationalNumbers rational11 = new(4, 7);
            RationalNumbers rational12 = new(8, 21);
